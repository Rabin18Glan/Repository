...
export default function Footer() {
    return (
        <div className="border-y bg-white dark:bg-black" >
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                <div className="md:flex md:justify-between">
                    ...
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        ...
                        <div>
                        <Typography className=" text-sm font-semibold uppercase" sx={{ my:'20px',fontWeight:'bold' }}>Follow Us</Typography>
                            <ul className="text-gray-500 font-medium">
                                <li className="mb-4">
                                    <a
                                        href=""
                                ...
                                <li className="mb-4">
                                    <a
                                        href="https://github.com/Rabin18Glan/Rabin18Glan"
                                        className="hover:underline"
                                        target="_blank"
                                rel='noopener'
                                    >
